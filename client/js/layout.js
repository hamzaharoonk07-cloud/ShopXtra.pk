      ...
      <div class="navbar-top container">
        ...
        <div class="collapse navbar-links-collapse" id="navLinksRow">
          <ul class="navbar-links-row">
            ...
            ${renderCategoryDropdownItem('detergents', 'Detergents')}
    ...
    <footer class="site-footer">
      <div class="footer-main">
        ...
        <div class="footer-col">
          ...
          <a href="/pages/shop.html?category=detergents">Detergents</a>
      ...
      <div class="footer-bottom-bar">
        ...
        <span>Cash on Delivery &middot; 5 to 7 day nationwide delivery</span>
      </div>
    </footer>
  `;
}
